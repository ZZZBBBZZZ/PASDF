...
sys.path.append(os.path.abspath(os.path.join(current_dir, "../../DeepSDF_ofo")))
...
# dataset_path = r"/home/dataset/zbz_new/DeepSDF_ofo/data/Real3D_AD"
# results_path = r"/home/dataset/zbz_new/DeepSDF_ofo/results"
# results_runs_sdf_path = r"/home/dataset/zbz_new/DeepSDF_ofo/results/Real3D_AD/runs_sdf"
# config_files_path = r"/home/dataset/zbz_new/DeepSDF_ofo/config_files"


dataset_path = r"../data/Real3D_AD"
results_path = r"../results"
results_runs_sdf_path = r"../results/Real3D_AD/runs_sdf"
config_files_path = r"../config_files"
...
class Trainer():
    ...
    def __call__(self):
        ...
        for class_idx in list(samples_dict.keys()):
            ...
            self.model = sdf_model.SDFModel_ofo(
