...
dataset_path = r"/home/lc/Desktop/wza/gjy/DeepSDF_ofo/data/Real3D_AD"
results_path = r"/home/lc/Desktop/wza/gjy/DeepSDF_ofo/results"
results_runs_sdf_path = r"/home/lc/Desktop/wza/gjy/DeepSDF_ofo/results/Real3D_AD/runs_sdf/pose_no_ofo"
...
class Trainer():
    ...
    def __call__(self):
        ...
        for class_idx in list(samples_dict.keys())[0:6]:
            ...
            self.model = sdf_model.SDFModel_PoseEmbedder(
    ...
    def generate_xy(self, batch):
        ...
        x = torch.hstack((latent_codes_batch, encoded_xyz))                  # shape (batch_size, 131)
...
if __name__=='__main__':
    train_cfg_path = os.path.join(config_files_path , 'train_sdf.yaml')
