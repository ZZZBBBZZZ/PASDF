...
def read_params(cfg):
    ...
    # print(cfg['folder_sdf'])
    training_settings_path = os.path.join(os.path.dirname(r"/home/lc/Desktop/liwq/codes/DeepSDF/results/runs_sdf/"),  cfg['folder_sdf'], 'settings.yaml') 
...
def reconstruct_object(cfg, latent_code, obj_idx, model, coords_batches, grad_size_axis): 
    ...
    # save mesh as obj
    mesh_dir = os.path.join(os.path.dirname(r"/home/lc/Desktop/liwq/codes/DeepSDF/results/runs_sdf/"), cfg['folder_sdf'], 'meshes_training')
...
def main(cfg):
    ...
    model_dir = os.path.join(os.path.dirname(r"/home/lc/Desktop/liwq/codes/DeepSDF/results/runs_sdf/"), cfg['folder_sdf'])
