...
def reconstruct_object(cfg, latent_code, obj_idx, model, coords_batches, grad_size_axis): 
    ...
    # save mesh as obj
    mesh_dir = os.path.join('/home/lc/Desktop/wza/gjy/DeepSDF_ofo/results/Real3D_AD/runs_sdf', cfg['folder_sdf'], 'meshes_training')
...
def main(cfg):
    ...
    for class_name in obj_ids:
        weights = os.path.join('/home/lc/Desktop/wza/gjy/DeepSDF_ofo/results/Real3D_AD/runs_sdf', cfg['folder_sdf'],class_name, 'weights.pt')
...
if __name__ == '__main__':
    ...
    cfg_path = os.path.join(r"/home/lc/Desktop/wza/gjy/DeepSDF_ofo/config_files", 'reconstruct_from_latent_Real3D_AD.yaml')
